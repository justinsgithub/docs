...
## toggling the display of an element
...
const AddAppointment = () => {
    ...
    const bottomSquare = "bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md"
    const bottomRound = "bg-blue-400 text-white px-2 py-3 w-full text-left rounded-md"

    return (
    <div>
      <button onClick={() => {setToggleForm(!toggleForm)}} className={toggleForm ? bottomSquare : bottomRound}>
